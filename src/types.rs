pub const TYPES: [(&str, usize, usize); 947] = [
    ...
    ("video/mpeg", 1155, 5),
    ("video/ogg", 1160, 1),
    ("video/quicktime", 1161, 2),
    ("video/vnd.dece.hd", 1163, 2),
    ("video/vnd.dece.mobile", 1165, 2),
    ("video/vnd.dece.pd", 1167, 2),
    ("video/vnd.dece.sd", 1169, 2),
    ("video/vnd.dece.video", 1171, 2),
    ("video/vnd.dvb.file", 1173, 1),
    ("video/vnd.fvt", 1174, 1),
    ("video/vnd.mpegurl", 1175, 2),
    ("video/vnd.ms-playready.media.pyv", 1177, 1),
    ("video/vnd.uvvu.mp4", 1178, 2),
    ("video/vnd.vivo", 1180, 1),
    ("video/webm", 1181, 1),
    ("video/x-f4v", 1182, 1),
    ("video/x-fli", 1183, 1),
    ("video/x-flv", 1184, 1),
    ("video/x-m4v", 1185, 1),
    ("video/x-matroska", 1186, 3),
    ("video/x-mng", 1189, 1),
    ("video/x-ms-asf", 1190, 2),
    ("video/x-ms-vob", 1192, 1),
    ("video/x-ms-wm", 1193, 1),
    ("video/x-ms-wmv", 1194, 1),
    ("video/x-ms-wmx", 1195, 1),
    ("video/x-ms-wvx", 1196, 1),
    ("video/x-msvideo", 1197, 1),
    ("video/x-sgi-movie", 1198, 1),
    ("video/x-smv", 1199, 1),
    ("x-conference/x-cooltalk", 1200, 1),
];
