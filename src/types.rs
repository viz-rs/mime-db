pub const TYPES: [(&str, usize, usize); 949] = [
    ...
    ("application/xcap-error+xml", 812, 1),
    ("application/xcap-ns+xml", 813, 1),
    ("application/xenc+xml", 814, 1),
    ("application/xhtml+xml", 815, 2),
    ("application/xliff+xml", 817, 1),
    ("application/xml", 818, 4),
    ("application/xml-dtd", 822, 1),
    ("application/xop+xml", 823, 1),
    ("application/xproc+xml", 824, 1),
    ("application/xslt+xml", 825, 2),
    ("application/xspf+xml", 827, 1),
    ("application/xv+xml", 828, 4),
    ("application/yang", 832, 1),
    ("application/yin+xml", 833, 1),
    ("application/zip", 834, 1),
    ("audio/3gpp", 835, 1),
    ("audio/adpcm", 836, 1),
    ("audio/amr", 837, 1),
    ("audio/basic", 838, 2),
    ("audio/midi", 840, 4),
    ("audio/mobile-xmf", 844, 1),
    ("audio/mp3", 845, 1),
    ("audio/mp4", 846, 2),
    ("audio/mpeg", 848, 6),
    ("audio/ogg", 854, 4),
    ("audio/s3m", 858, 1),
    ("audio/silk", 859, 1),
    ("audio/vnd.dece.audio", 860, 2),
    ("audio/vnd.digital-winds", 862, 1),
    ("audio/vnd.dra", 863, 1),
    ("audio/vnd.dts", 864, 1),
    ("audio/vnd.dts.hd", 865, 1),
    ("audio/vnd.lucent.voice", 866, 1),
    ("audio/vnd.ms-playready.media.pya", 867, 1),
    ("audio/vnd.nuera.ecelp4800", 868, 1),
    ("audio/vnd.nuera.ecelp7470", 869, 1),
    ("audio/vnd.nuera.ecelp9600", 870, 1),
    ("audio/vnd.rip", 871, 1),
    ("audio/wav", 872, 1),
    ("audio/wave", 873, 1),
    ("audio/webm", 874, 1),
    ...
    ("audio/x-flac", 880, 1),
    ("audio/x-m4a", 881, 1),
    ("audio/x-matroska", 882, 1),
    ("audio/x-mpegurl", 883, 1),
    ("audio/x-ms-wax", 884, 1),
    ("audio/x-ms-wma", 885, 1),
    ("audio/x-pn-realaudio", 886, 2),
    ("audio/x-pn-realaudio-plugin", 888, 1),
    ("audio/x-realaudio", 889, 1),
    ("audio/x-wav", 890, 1),
    ("audio/xm", 891, 1),
    ("chemical/x-cdx", 892, 1),
    ("chemical/x-cif", 893, 1),
    ("chemical/x-cmdf", 894, 1),
    ("chemical/x-cml", 895, 1),
    ("chemical/x-csml", 896, 1),
    ("chemical/x-xyz", 897, 1),
    ("font/collection", 898, 1),
    ("font/otf", 899, 1),
    ("font/ttf", 900, 1),
    ("font/woff", 901, 1),
    ("font/woff2", 902, 1),
    ...
    ("image/bmp", 906, 1),
    ("image/cgm", 907, 1),
    ("image/dicom-rle", 908, 1),
    ("image/emf", 909, 1),
    ("image/fits", 910, 1),
    ("image/g3fax", 911, 1),
    ("image/gif", 912, 1),
    ("image/heic", 913, 1),
    ("image/heic-sequence", 914, 1),
    ("image/heif", 915, 1),
    ("image/heif-sequence", 916, 1),
    ("image/hej2k", 917, 1),
    ("image/hsj2", 918, 1),
    ("image/ief", 919, 1),
    ("image/jls", 920, 1),
    ...
    ("image/tiff", 947, 2),
    ("image/tiff-fx", 949, 1),
    ("image/vnd.adobe.photoshop", 950, 1),
    ("image/vnd.airzip.accelerator.azv", 951, 1),
    ("image/vnd.dece.graphic", 952, 4),
    ("image/vnd.djvu", 956, 2),
    ("image/vnd.dvb.subtitle", 958, 1),
    ("image/vnd.dwg", 959, 1),
    ("image/vnd.dxf", 960, 1),
    ("image/vnd.fastbidsheet", 961, 1),
    ("image/vnd.fpx", 962, 1),
    ("image/vnd.fst", 963, 1),
    ("image/vnd.fujixerox.edmics-mmr", 964, 1),
    ("image/vnd.fujixerox.edmics-rlc", 965, 1),
    ("image/vnd.microsoft.icon", 966, 1),
    ("image/vnd.ms-dds", 967, 1),
    ("image/vnd.ms-modi", 968, 1),
    ("image/vnd.ms-photo", 969, 1),
    ("image/vnd.net-fpx", 970, 1),
    ("image/vnd.pco.b16", 971, 1),
    ("image/vnd.tencent.tap", 972, 1),
    ("image/vnd.valve.source.texture", 973, 1),
    ("image/vnd.wap.wbmp", 974, 1),
    ("image/vnd.xiff", 975, 1),
    ("image/vnd.zbrush.pcx", 976, 1),
    ("image/webp", 977, 1),
    ("image/wmf", 978, 1),
    ("image/x-3ds", 979, 1),
    ("image/x-cmu-raster", 980, 1),
    ("image/x-cmx", 981, 1),
    ("image/x-freehand", 982, 5),
    ("image/x-icon", 987, 1),
    ("image/x-jng", 988, 1),
    ("image/x-mrsid-image", 989, 1),
    ("image/x-ms-bmp", 990, 1),
    ("image/x-pcx", 991, 1),
    ("image/x-pict", 992, 2),
    ("image/x-portable-anymap", 994, 1),
    ("image/x-portable-bitmap", 995, 1),
    ("image/x-portable-graymap", 996, 1),
    ("image/x-portable-pixmap", 997, 1),
    ("image/x-rgb", 998, 1),
    ("image/x-tga", 999, 1),
    ("image/x-xbitmap", 1000, 1),
    ("image/x-xpixmap", 1001, 1),
    ("image/x-xwindowdump", 1002, 1),
    ("message/disposition-notification", 1003, 1),
    ("message/global", 1004, 1),
    ("message/global-delivery-status", 1005, 1),
    ("message/global-disposition-notification", 1006, 1),
    ("message/global-headers", 1007, 1),
    ("message/rfc822", 1008, 2),
    ("message/vnd.wfa.wsc", 1010, 1),
    ("model/3mf", 1011, 1),
    ("model/gltf+json", 1012, 1),
    ("model/gltf-binary", 1013, 1),
    ("model/iges", 1014, 2),
    ("model/mesh", 1016, 3),
    ("model/mtl", 1019, 1),
    ("model/obj", 1020, 1),
    ("model/stl", 1021, 1),
    ("model/vnd.collada+xml", 1022, 1),
    ("model/vnd.dwf", 1023, 1),
    ("model/vnd.gdl", 1024, 1),
    ("model/vnd.gtw", 1025, 1),
    ("model/vnd.mts", 1026, 1),
    ("model/vnd.opengex", 1027, 1),
    ("model/vnd.parasolid.transmit.binary", 1028, 1),
    ("model/vnd.parasolid.transmit.text", 1029, 1),
    ("model/vnd.usdz+zip", 1030, 1),
    ("model/vnd.valve.source.compiled-map", 1031, 1),
    ("model/vnd.vtu", 1032, 1),
    ("model/vrml", 1033, 2),
    ("model/x3d+binary", 1035, 2),
    ("model/x3d+fastinfoset", 1037, 1),
    ("model/x3d+vrml", 1038, 2),
    ("model/x3d+xml", 1040, 2),
    ("model/x3d-vrml", 1042, 1),
    ("text/cache-manifest", 1043, 2),
    ("text/calendar", 1045, 2),
    ("text/coffeescript", 1047, 2),
    ("text/css", 1049, 1),
    ("text/csv", 1050, 1),
    ("text/html", 1051, 3),
    ("text/jade", 1054, 1),
    ("text/jsx", 1055, 1),
    ("text/less", 1056, 1),
    ("text/markdown", 1057, 2),
    ("text/mathml", 1059, 1),
    ("text/mdx", 1060, 1),
    ("text/n3", 1061, 1),
    ("text/plain", 1062, 8),
    ("text/prs.lines.tag", 1070, 1),
    ("text/richtext", 1071, 1),
    ("text/rtf", 1072, 1),
    ("text/sgml", 1073, 2),
    ("text/shex", 1075, 1),
    ("text/slim", 1076, 2),
    ("text/spdx", 1078, 1),
    ("text/stylus", 1079, 2),
    ("text/tab-separated-values", 1081, 1),
    ("text/troff", 1082, 6),
    ("text/turtle", 1088, 1),
    ("text/uri-list", 1089, 3),
    ("text/vcard", 1092, 1),
    ("text/vnd.curl", 1093, 1),
    ("text/vnd.curl.dcurl", 1094, 1),
    ("text/vnd.curl.mcurl", 1095, 1),
    ("text/vnd.curl.scurl", 1096, 1),
    ("text/vnd.dvb.subtitle", 1097, 1),
    ("text/vnd.fly", 1098, 1),
    ("text/vnd.fmi.flexstor", 1099, 1),
    ("text/vnd.graphviz", 1100, 1),
    ("text/vnd.in3d.3dml", 1101, 1),
    ("text/vnd.in3d.spot", 1102, 1),
    ("text/vnd.sun.j2me.app-descriptor", 1103, 1),
    ("text/vnd.wap.wml", 1104, 1),
    ("text/vnd.wap.wmlscript", 1105, 1),
    ("text/vtt", 1106, 1),
    ("text/x-asm", 1107, 2),
    ("text/x-c", 1109, 7),
    ("text/x-component", 1116, 1),
    ("text/x-fortran", 1117, 4),
    ("text/x-handlebars-template", 1121, 1),
    ("text/x-java-source", 1122, 1),
    ("text/x-lua", 1123, 1),
    ("text/x-markdown", 1124, 1),
    ("text/x-nfo", 1125, 1),
    ("text/x-opml", 1126, 1),
    ("text/x-org", 1127, 1),
    ("text/x-pascal", 1128, 2),
    ("text/x-processing", 1130, 1),
    ("text/x-sass", 1131, 1),
    ("text/x-scss", 1132, 1),
    ("text/x-setext", 1133, 1),
    ("text/x-sfv", 1134, 1),
    ("text/x-suse-ymp", 1135, 1),
    ("text/x-uuencode", 1136, 1),
    ("text/x-vcalendar", 1137, 1),
    ("text/x-vcard", 1138, 1),
    ("text/xml", 1139, 1),
    ("text/yaml", 1140, 2),
    ("video/3gpp", 1142, 2),
    ...
    ("video/mpeg", 1158, 5),
    ("video/ogg", 1163, 1),
    ("video/quicktime", 1164, 2),
    ("video/vnd.dece.hd", 1166, 2),
    ("video/vnd.dece.mobile", 1168, 2),
    ("video/vnd.dece.pd", 1170, 2),
    ("video/vnd.dece.sd", 1172, 2),
    ("video/vnd.dece.video", 1174, 2),
    ("video/vnd.dvb.file", 1176, 1),
    ("video/vnd.fvt", 1177, 1),
    ("video/vnd.mpegurl", 1178, 2),
    ("video/vnd.ms-playready.media.pyv", 1180, 1),
    ("video/vnd.uvvu.mp4", 1181, 2),
    ("video/vnd.vivo", 1183, 1),
    ("video/webm", 1184, 1),
    ("video/x-f4v", 1185, 1),
    ("video/x-fli", 1186, 1),
    ("video/x-flv", 1187, 1),
    ("video/x-m4v", 1188, 1),
    ("video/x-matroska", 1189, 3),
    ("video/x-mng", 1192, 1),
    ("video/x-ms-asf", 1193, 2),
    ("video/x-ms-vob", 1195, 1),
    ("video/x-ms-wm", 1196, 1),
    ("video/x-ms-wmv", 1197, 1),
    ("video/x-ms-wmx", 1198, 1),
    ("video/x-ms-wvx", 1199, 1),
    ("video/x-msvideo", 1200, 1),
    ("video/x-sgi-movie", 1201, 1),
    ("video/x-smv", 1202, 1),
    ("x-conference/x-cooltalk", 1203, 1),
];
